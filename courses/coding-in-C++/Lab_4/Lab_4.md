...
- Think about whether this function should be declared as virtual and why - Should be vurtual
- Think about whether this class needs a destructor and if so, what kind of destructor needs a virtual destructor
